...
if ($ADMIN->fulltree) {
    ...
    $settings->add(new admin_setting_heading('media_rutube_settings',
    ...
    $settings->add(new admin_setting_configcheckbox('media_rutube/nocookie',
        new lang_string('nocookie', 'media_rutube'),
        new lang_string('nocookie_desc', 'media_rutube'), 0));
}
